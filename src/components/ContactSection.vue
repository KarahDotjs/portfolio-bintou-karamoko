  ...
  try {
    await emailjs.send(
      ...
      'YOUR_TEMPLATE_ID',
      {
        ...
        to_email: 'bintoukaramoko3@gmail.com'
      },
      'YOUR_PUBLIC_KEY'
    )
    success.value = true
      ...
      <div class="contact-layout">
        ...
        <div class="contact-left reveal reveal-d1">
          ...
          <div class="contact-info-card">
            <div class="cinfo-item">
              ...
              <div>
                ...
                <div class="cinfo-val">bintoukaramoko3@gmail.com</div>
              </div>
            </div>
            <div class="cinfo-item">
            ...
            <div class="cinfo-item">
              ...
              <div>
                ...
                <div class="cinfo-val">Stage · Juin 2026 · 3 mois</div>
              </div>
            </div>
          </div>
          ...
          <div class="contact-socials">
            ...
            <a href="mailto:bintoukaramoko3@gmail.com" class="social-btn">
